...
@synthesize bitThisVC = _bitThisVC;
...
//    }
//    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"BitThis" withExtension:@"momd"];
...
//    }
//    
//    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"BitThis.sqlite"];
//    
//    NSError *error = nil;
